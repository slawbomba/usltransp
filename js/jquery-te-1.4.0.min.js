...
(function (e) {
    e.fn.jqte = function (t) {
        ...
        var i = ["10", "12", "16", "18", "20", "24", "28"];//rozmiar czcionki
        ...
        return this.each(function () {
            ...
            function z(t) {
                ...
                R(t);
                t.removeAttr(S);
                if ((w.data("linktype") == "0") || (w.data("linktype") == "1")) j("createlink", y.val());
                else if (w.data("linktype") == "2") {
                    j("insertImage", y.val());
            ...
            else e(this).data("jqte", false); if (!u.status || !e(this).data("jqte")) {
            ...
            d.append('<div class="' + u.css + '_linktypeselect" unselectable></div><textarea class="' + u.css + '_linkinput" style="max-height:40px; max-width:500px;" type="text/css" value=""></textarea><div class="' + u.css + '_linkbutton" unselectable>' + u.button + '</div> <div style="height:1px;float:none;clear:both"></div>');
            ...
            else O = ""; if (u.placeholder && u.placeholder != "") {
